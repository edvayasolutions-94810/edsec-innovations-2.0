...
const Enroll = () => {
  ...
  const { predefinedCourse, predefinedDomain, domain } = location.state || {};
  ...
  const initialDomain = predefinedDomain || domain || '';
          ...
          <div className={`${cardBg} ${cardGlow} max-w-2xl mx-auto rounded-3xl p-8 transition-all duration-300`}>
            {isSubmitted ? (
              <div className="text-center py-10 animate-fade-in">
                ...
                <h2 className={`text-2xl font-bold mb-4 ${titleClr}`}>✅ Enrollment submitted successfully.</h2>
                <p className={`text-base ${mutedClr} max-w-md mx-auto mb-8`}>
                  Our team has received your application and will contact you shortly.
                </p>
                <Button
                  onClick={() => navigate('/')}
                  className={`h-12 px-8 font-bold rounded-xl flex items-center justify-center gap-2 mx-auto ${btnClass}`}
                >
