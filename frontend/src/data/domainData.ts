...
export const domainData: DomainData[] = [
  // ── SKILL ENHANCEMENT PROGRAM (1 Month, ₹1999) ──────────────────────────
  {
    ...
    brochureUrl: '/brochures/SQL Training Program.pdf',
    brochureFilename: 'SQL Training Program.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    brochureUrl: '/brochures/Core Python Training Program.pdf',
    brochureFilename: 'Core Python Training Program.pdf',
    syllabus: [
      {
        title: 'Python Basics',
  ...
  },
  {
    ...
    brochureUrl: '/brochures/AUGMENTED REALITY Training Syllabus.pdf',
    brochureFilename: 'AUGMENTED REALITY Training Syllabus.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    brochureUrl: '/brochures/Digital Marketing Training.pdf',
    brochureFilename: 'Digital Marketing Training.pdf',
    syllabus: [
      {
  ...
  // ── INDUSTRY INTERNSHIP PROGRAM (3 Months, ₹3499) ───────────────────────
  {
    ...
    programTitle: 'Advanced Technology Program',
    level: 'Intermediate',
    duration: '3 Months',
    price: '3499',
    ...
    brochureUrl: '/brochures/Data Analytics Training Syllabus.pdf',
    brochureFilename: 'Data Analytics Training Syllabus.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    brochureUrl: '/brochures/Web Development Training Syllabus.pdf',
    brochureFilename: 'Web Development Training Syllabus.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    brochureUrl: '/brochures/Generative AI Training Program.pdf',
    brochureFilename: 'Generative AI Training Program.pdf',
    syllabus: [
      {
  ...
  // ── ADVANCED INDUSTRY INTERNSHIP (5 Months, ₹4999) ──────────────────────
  {
    ...
    brochureUrl: '/brochures/Data Science Training Syllabus.pdf',
    brochureFilename: 'Data Science Training Syllabus.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    features: ['Two industry projects', 'Resume building support', 'LinkedIn optimization', 'Internship Offer Letter', 'MSME Certificate'],
    brochureUrl: '/brochures/Python Full Stack Training Syllabus.pdf',
    brochureFilename: 'Python Full Stack Training Syllabus.pdf',
    syllabus: [
      {
  ...
  },
  {
    ...
    features: ['Two industry projects', 'Resume building support', 'LinkedIn optimization', 'Internship Offer Letter', 'MSME Certificate'],
    brochureUrl: '/brochures/AI_ML Training Syllabus.pdf',
    brochureFilename: 'AI_ML Training Syllabus.pdf',
    syllabus: [
      {
